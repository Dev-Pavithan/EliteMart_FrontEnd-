        ...
        <div className="flex h-screen">
            <div className="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
                <div className="max-w-md text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="524.67004" height="531.39694" className="w-full" alt="Illustration" title="Illustration" viewBox="0 0 524.67004 531.39694">
                        ...
                        <path d="M0,523.44458c0,.66003,.53003,1.19,1.19006,1.19H523.48004c.65997,0,1.19-.52997,1.19-1.19,0-.65997-.53003-1.19-1.19-1.19H1.19006c-.66003,0-1.19006,.53003-1.19006,1.19Z" fill="#ff5f15" />
                        <g>
                            ...
                            <path d="M356.03781,523.20093H150.36888c-23.83691,0-43.22998-19.39258-43.22998-43.22949v-199.43262c0-23.83691,19.39307-43.22998,43.22998-43.22998h205.66896c23.83691,0,43.22998,19.39307,43.22998,43.22998v199.43262c0,23.83691-19.39307,43.22949-43.22998,43.22949h-.00003ZM150.36888,239.30882c-22.73438,0-41.22998,18.49562-41.22998,41.23v199.43262c0,22.73438,18.49561,41.22949,41.22998,41.22949h205.66896c22.73438,0,41.22998-18.49512,41.22998-41.22949v-199.43262c0-22.73438-18.49561-41.22998-41.22998-41.22998H150.36888v-.00002Z" fill="#ff5f15" />
                            <path d="M370.93558,324.77005h-82.66788c-3.50635,0-6.35907-2.85272-6.35907-6.35907s2.85272-6.35907,6.35907-6.35907h82.66785c3.50635,0,6.35907,2.85272,6.35907,6.35907s-2.85272,6.35907-6.35907,6.35907h.00003Z" fill="#ff5f15" />
                            <path d="M293.3822,374.77737h-80.3571c-2.02586,0-3.67427-1.64841-3.67427-3.67429s1.64841-3.67352,3.67427-3.67352h80.3571c2.02588,0,3.67352,1.64764,3.67352,3.67352s-1.64764,3.67426-3.67352,3.67426v.00003Z" fill="#ff5f15" />
                            <rect x="133.61763" y="251.96666" width="46.49806" height="5.96129" rx=".31021" ry=".31021" fill="#ff5f15" />
                            <circle cx="334.3363" cy="253.15892" r="4.76904" fill="#ff5f15" />
                            <circle cx="347.45114" cy="253.15892" r="4.76904" fill="#ff5f15" />
                            <circle cx="360.56598" cy="253.15892" r="4.76904" fill="#ff5f15" />
                            <path d="M149.86826,394.44458c0,.66003,.53003,1.19,1.19006,1.19h204.28998c.65997,0,1.19-.52997,1.19-1.19,0-.65997-.53003-1.19-1.19-1.19H151.05832c-.66003,0-1.19006,.53003-1.19006,1.19Z" fill="#ff5f15" />
                        </g>
                        <g>
                        ...
                        <g>
                            ...
                            <path d="M399.05911,52.11928v3.47462H228.38948c-.47775,0-.91208-.19113-1.22478-.51253-.32146-.3127-.51253-.74703-.51253-1.22478,0-.95555,.78181-1.73731,1.7373-1.73731h170.66963Z" fill="#ff5f15" />
                            ...
                            <path d="M332.1727,91.20873v3.47462h-103.78322c-.47775,0-.91208-.19113-1.22478-.51253-.32146-.3127-.51253-.74703-.51253-1.22478,0-.95555,.78181-1.73731,1.7373-1.73731h103.78322Z" fill="#ff5f15" />
            ...
            <div className="w-full bg-orange-100 lg:w-1/2 flex items-center justify-center">
                <div className="max-w-md w-full p-6">
                    <h1 className="text-3xl font-semibold mb-6 text-black text-center">Sign Up</h1>
                    <h1 className="text-sm font-semibold mb-6 text-orange-500 text-center">Join to Our Community with all time access and free </h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                id="name"
                                name="name"
                                className="mt-1 p-2 w-full border rounded-md focus:border-orange-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-300 transition-colors duration-300"
                                value={formData.name}
                        ...
                        <div>
                            <label htmlFor="street" className="block text-sm font-medium text-orange-700">
                                Street
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="flex space-x-4">
                            <div className="flex-1">
                                <label htmlFor="city" className="block text-sm font-medium text-orange-700">
                                    City
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="flex-1">
                                <label htmlFor="state" className="block text-sm font-medium text-orange-700">
                                    State
                                </label>
                                <input
                                    type="text"
                        ...
                        <div className="flex space-x-4">
                            <div className="flex-1">
                                <label htmlFor="postalCode" className="block text-sm font-medium text-orange-700">
                                    Postal Code
                                </label>
                                <input
                                    type="text"
                        ...
                        <div>
                            <button
                                type="submit"
                                className="w-full bg-black text-white p-2 rounded-md hover:bg-orange-800 focus:outline-none focus:bg-black focus:ring-2 focus:ring-offset-2 focus:ring-orange-900 transition-colors duration-300"
                            >
                                Sign Up
                            </button>
                        </div>
